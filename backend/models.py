...
class UIComponentOption(BaseModel):
    """Single option in a UI component"""
...
class UIComponent(BaseModel):
    """Dynamic UI component generated by LLM for preference collection"""
    type: Literal["buttons", "single_select", "multi_select", "confirm"]
    question_id: str = Field(..., max_length=50)
    prompt: str = Field(..., max_length=500)
    options: List[UIComponentOption] = Field(..., min_length=2, max_length=10)
    category: Literal["dietary", "schedule", "goals", "feedback"]
    allow_skip: bool = True


class PreferenceUpdate(BaseModel):
    """User's response from a preference UI component"""
    question_id: str = Field(..., max_length=50)
